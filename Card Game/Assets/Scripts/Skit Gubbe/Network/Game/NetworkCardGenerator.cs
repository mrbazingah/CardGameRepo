...
public class NetworkCardGenerator : NetworkBehaviour
{
    ...
    public void FindLocalPlayer(NetworkPlayer newLocalPlayer)
    {
        localPlayer = newLocalPlayer;
    }

    public void FindOpponentPlayer(NetworkPlayer newOpponentPlayer)
    {
    ...
    public void DealPlayerCards()
    {
        ...
        localPlayer.SetUnderSideCards(underSideCards);
        localPlayer.SetOverSideCards(overSideCards);
        localPlayer.SortHandCards();
    }
    ...
    public GameObject GetChanceCard()
    {
        ...
        if ((!localPlayer.CanChance() && localPlayer.GetTurn()) || (!ai.CanChance() && ai.GetTurn()) || !canDrawChanceCard) { return null; }
