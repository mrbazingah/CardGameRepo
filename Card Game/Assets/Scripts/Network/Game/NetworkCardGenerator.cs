...
public class NetworkCardGenerator : NetworkBehaviour
{
    ...
    void Awake()
    {
        ...
        opponent = FindFirstObjectByType<NetworkOpponentHand>();
    ...
    void GenerateDeck()
    {
        ...
        {
            currentCardValue++;
            if ((currentCardValue == 2 || currentCardValue == 10) && removeSpecialCards) { continue; }
    ...
    void DealOpponentCards()
    {
        ...
        opponent.SetUnderSideCards(underSideCards);
        opponent.SetOverSideCards(overSideCards);
        opponent.SwitchOutSideCards();
    }
    #endregion
    ...
    public GameObject GetChanceCard()
    {
        ...
        if ((!player.CanChance() && player.GetTurn()) || (!opponent.CanChance() && opponent.GetTurn()) || !canDrawChanceCard) { return null; }
